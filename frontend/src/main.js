...
registerMicroApps(
  [
    { name: 'vue-sub-app1', entry: '//localhost:9101', render, activeRule: genActiveRule('/sub-app1') },
    { name: 'vue-sub-app2', entry: '//localhost:9102', render, activeRule: genActiveRule('/sub-app2') },
    { name: 'vue-sub-app3', entry: '//localhost:9103', render, activeRule: genActiveRule('/sub-app3') },
  ],
  {
    beforeLoad: [
      app => {
